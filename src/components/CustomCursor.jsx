...
export const CustomCursor = () => {
  ...
  }, [preferences.cursor, preferences.motion, x, y]);
  ...
  return (
    <motion.div
      aria-hidden="true"
      className="pointer-events-none fixed z-[9999] h-9 w-9 rounded-full border border-primary/35"
      style={{
        x,
        y,
        mixBlendMode: "screen",
