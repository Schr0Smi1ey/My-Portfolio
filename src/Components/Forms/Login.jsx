...
const Login = () => {
  const { signInUser, signInWithGoogle, Toast } =
  ...
  return (
    <div className={`py-32`}>
      <Helmet>
        <title>Schr0Smi1ey | Login</title>
      </Helmet>
      <div
        className={`min-h-[600px] flex bg-white w-full container mx-auto max-w-3xl shadow-lg  rounded-lg overflow-hidden`}
      >
        <div
